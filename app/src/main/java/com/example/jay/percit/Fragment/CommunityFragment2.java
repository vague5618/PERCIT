...
public class CommunityFragment2 extends Fragment  {
    ...
    public static CommunityFragment2 newInstance() {
        ...
        CommunityFragment2 fragment = new CommunityFragment2();
//        Bundle args = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_community1, container, false);
        ...
        mGrowAnim = AnimationUtils.loadAnimation(CommunityActivity.mContext, R.anim.grow);

        mFeedbackAnim =AnimationUtils.loadAnimation(CommunityActivity.mContext, R.anim.scale);

       mButton_record_mic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

               CommunityActivity.state = RECORD_MODE;

                for(int i=0; i<CommunityActivity.record_arr.length; i++)
                    CommunityActivity.record_arr[i] = 0;

                for(int i=0; i<CommunityActivity.record_power.length; i++)
                    CommunityActivity.record_power[i] = 0;

               CommunityActivity.gRecordThread.record_start();
        ...
        mButton_play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CommunityActivity.state = PLAY_MODE;
                CommunityActivity.gRecordThread.Play_Recorded(CommunityActivity.record_arr, CommunityActivity.record_power);
                mProgressbar.startAnimation(mGrowAnim);
            }
        });
