...
public class Musicstage_Id_Setup {
    ...
    void setUp() {
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        MusicStage_Id(1, R.id.musicstage_image1, R.id.musicstage_information1,
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        ...
                        MusicStage_Id(2, R.id.musicstage_image2, R.id.musicstage_information2,
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        ...
                        MusicStage_Id(3, R.id.musicstage_image3, R.id.musicstage_information3,
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        ...
                        MusicStage_Id(4, R.id.musicstage_image4, R.id.musicstage_information4,
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        ...
                        MusicStage_Id(5, R.id.musicstage_image5, R.id.musicstage_information5,
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        ...
                        MusicStage_Id(6, R.id.musicstage_image6, R.id.musicstage_information6,
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        ...
                        MusicStage_Id(7, R.id.musicstage_image7, R.id.musicstage_information7,
        ...
        musicStageIdDAO.setMusicStage_Id(new
                        ...
                        MusicStage_Id(8, R.id.musicstage_image8, R.id.musicstage_information8,
