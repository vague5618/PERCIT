...
public class Musicstage_Image_Setup {
    ...
    void setUp() {
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(1, R.drawable.musicstage_main_01_pattern,
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(2, R.drawable.musicstage_main_02_pattern,
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(3, R.drawable.musicstage_main_03_pattern,
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(4, R.drawable.musicstage_main_04_pattern,
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(5, R.drawable.musicstage_main_05_pattern,
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(6, R.drawable.musicstage_main_06_pattern,
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(7, R.drawable.musicstage_main_07_pattern,
        ...
        musicStageImageDAO.setMusicstage_image(new MusicStage_Image(8, R.drawable.musicstage_main_08_pattern,
