...
public class MusicStage_IdSetup {
    ...
    public MusicStage_IdSetup(ArrayList<MusicStage_IdModel> musicStage_id_models) {
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image1, R.id.musicstage_information1,
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image2, R.id.musicstage_information2,
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image3, R.id.musicstage_information3,
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image4, R.id.musicstage_information4,
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image5, R.id.musicstage_information5,
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image6, R.id.musicstage_information6,
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image7, R.id.musicstage_information7,
        ...
        musicStage_id_models.add(new MusicStage_IdModel(R.id.musicstage_image8, R.id.musicstage_information8,
