...
public class MusicStage_ImageSetup {
    ...
    private ArrayList<MusicStage_Image> musicStage_Image_models;

    public MusicStage_ImageSetup(ArrayList<MusicStage_Image> musicStage_Image_models) {

        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_01_pattern,
        ...
        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_02_pattern,
        ...
        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_03_pattern,
        ...
        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_04_pattern,
        ...
        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_05_pattern,
        ...
        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_06_pattern,
        ...
        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_07_pattern,
        ...
        musicStage_Image_models.add(new MusicStage_Image(R.drawable.musicstage_main_08_pattern,
