...
public class MusicStage_Image {
    ...
    public MusicStage_Image(int musicstage_image, int musicstage_information, int musicstage_progress1, int musicstage_progress2, int musicstage_progress3, String musicstage_bgnumber) {
    ...
    public MusicStage_Image(int musicstage_image, int musicstage_information, int musicstage_progress1, int musicstage_progress2, String musicstage_bgnumber) {
        this.musicstage_image = musicstage_image;
        this.musicstage_information = musicstage_information;
        this.musicstage_progress1 = musicstage_progress1;
        this.musicstage_progress2 = musicstage_progress2;
