 ...
 */
public class MusicStageFragment4 extends Fragment  {
    ...
    public static MusicStageFragment4 newInstance() {

        MusicStageFragment4 fragment = new MusicStageFragment4();
//        Bundle args = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_musicstage4, container, false);
